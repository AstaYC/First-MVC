                        ...
                        <tr class="freelancer">
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-3">
                                        <p class="fw-bold mb-1 f_name">username</p>
                                       
                                    </div>
                                </div>
                            </td>
                            <td>
                                <p class="fw-normal mb-1 f_title">title</p>
                                
                            </td>
                            <td>
                                <span class="f_status">status</span>
                            </td>
                          
                            <td>
                               <a><img class="delet_user" src="img/user-x.svg" alt="" style="margin:1rem;"></a>
                                <button style="background-color:green; color:white;" id="accept-btn">accept</button>
                            </td>
                        </tr>
                    </tbody>
                </table>
